...
params={ 
    'start_date': '2024-10-01',#start_text,#'2024-06-28', 
...
params = {
    'start_date': '2024-10-01',#start_text, #'2024-06-28', #start_text (全期間が欲しい場合)
...
csv_file_path = r"g:\マイドライブ\ゼミ用\01_10_2024_DA38DDB3C43F_history.csv"
