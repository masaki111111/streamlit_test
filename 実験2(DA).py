...
params={ 
    'start_date': '2024-09-30',#start_text,#'2024-06-28', 
    'end_date': '2024-10-01'#end_text #'2024-06-30'
}
headers = { 
...
params = {
    'start_date': '2024-09-30',#start_text, #'2024-06-28', #start_text (全期間が欲しい場合)
    'end_date': '2024-10-01'#end_text #'2024-06-30' #end_text　(全期間が欲しい場合)
}
headers = { 
  'Authorization': 'Bearer XYJFZ6LI76CH3JX5VGUUCHT4JGWTEQRS' 
}
...
csv_file_path = r"c:\Users\owner\OneDrive - 大阪工業大学\ウエルネス研究室\福田勝基\Core\01_10_2024_DA38DDB3C43F_history.csv"
